...
class Photosession2Widget extends StatelessWidget {
  const Photosession2Widget({super.key});
      ...
      child: Container(
          ...
          child: Row(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(
                    left: 16, top: 5, right: 70, bottom: 10),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Filming with a video camera in the\n rooms"),
                    Text("250 LE")
                  ],
                ),
              ),
